...
class OrganizationSeeder extends Seeder
{
    public function run(): void
    {
        $organizations = [
            ...
            ['code' => 'HSF', 'address' => 'Tanguarín', 'ruc' => 5931783021, 'name'=>'Hijas de la Sagrada Familia'],
            ...
            ['code' => 'MSE', 'address' => 'Sector Chorlavisito', 'ruc' => null, 'name'=>'Misioneras Siervas del Divino Espíritu '],
